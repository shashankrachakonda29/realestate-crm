...
def inventory_create(request):
    ...
    if request.method == "POST":
        ...
        extra_built_up_area_sq_ft = decimal_value(
            "extra_built_up_area_sq_ft"
        )
        
        extra_built_up_rate_per_sq_ft = decimal_value(
            "extra_built_up_rate_per_sq_ft"
        )
...
def inventory_edit(request, pk):
    ...
    if request.method == "POST":
        ...
        inventory_item.extra_built_up_rate_per_sq_ft = (
            extra_built_up_rate_per_sq_ft
        )

        inventory_item.basic_sale_price_2 = (
            basic_sale_price_2
        )
